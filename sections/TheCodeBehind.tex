...
\begin{listing}[H]
 \inputminted[python3=true,bgcolor=Black,linenos=true,firstline=67,lastline=69]{python}{VNL/PythonScripts/Scripts/2DdataExtract.py}
 \caption{Lines 67-69 from the 2DdataExtract.py script shows how coordinates from a configuration of atoms can be easily obtained from the class \textit{VibrationalMode}.}
 \label{VM}
\end{listing}
\twocolumngrid
