%Basics
\documentclass[aps, prl, rerint, a4paper, english]{revtex4-1}
...
%Miscellaneous packages, definitions and new commands
\usepackage{silence}
\WarningFilter{revtex4-1}{Repair the float}
\WarningFilter{natbib}{Package natbib: Empty 'thebibliography' enviroment}
