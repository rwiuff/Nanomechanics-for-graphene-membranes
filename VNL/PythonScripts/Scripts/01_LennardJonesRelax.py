...
# a doubled layered membrane structure
...
# -------------------------------------------------------------
# Set zeta parameter like 0.31, 1.0, 10 for graphite, Si coupling
# (In SiO2) or something extremely strongly interacting, respectively.
Zeta = 1.0
# Set intralayer interaction.
...
lj_interlayer_potential = TremoloXPotentialSet(
    name="InterLayerPotential")
...
# Add Lennard-Jones potentials between the carbon atoms
# of different layers.
...
# Optimize Geometry
# -------------------------------------------------------------
# Optimise the geometry and positions of atoms
# according to the defined potential
